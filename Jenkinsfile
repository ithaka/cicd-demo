podTemplate(label: 'test', cloud: 'kubernetes',
    ...
    node("test") {
      ...
      try{
          ...
          container('kubectl'){
            stage('deploy app'){
                sh "helm upgrade --install --force --service-account tiller --tiller-namespace default --values ./hello-world/chart/values.yaml hello-world-app-${GIT_BRANCH} ./hello-world/chart"
            }
          }
          parallel(
          ...
          container('kubectl'){
                ...
                stage('deploy to prod'){
                    sh "helm upgrade --service-account tiller --install --force --tiller-namespace default --namespace prod --values ./hello-world/chart/values.yaml hello-world-app ./hello-world/chart"
                }
            }
